...
export default async function TerminosPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">Términos y Condiciones</h1>
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground/80">
        ...
        <section>
          ...
          <p>
            ...
            resuelta ante los tribunales competentes del domicilio de {siteName}.
          </p>
        </section>
